...
public class AutoDriveToCommandGroup extends CommandGroup {
	...
	public AutoDriveToCommandGroup(double x, double y) {
		/*
		 * System.out.println("I ran"); System.out.println(ahrs); currentX =
		 * ahrs.getDisplacementX(); System.out.println(currentX); currentY =
		 * ahrs.getDisplacementY(); System.out.println(currentY); currentAngle =
		 * ahrs.getAngle(); System.out.println(currentAngle);
		 */
